    ...
    return (
        <div className='grid grid-cols-3 gap-6'>
            {blogContent.map((item,index)=>(
                <div className="border border-[#d8d8db] rounded-xl p-4 flex justify-between flex-col gap-3 transition-all duration-300 hover:border-[#8267ec] hover:scale-105 group">
